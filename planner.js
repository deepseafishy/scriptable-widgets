...
const SIZE_STACK_E     = new Size(160, 110)
const SIZE_STACK_R     = new Size(160, 110)
...
// event stack sizes
const SIZE_EVENT_PAD           = new Size(140,  5)
const SIZE_EVENT_ALL_DAY_TITLE = new Size(140, 10)
const SIZE_EVENT_TITLE         = new Size(140, 20)
const SIZE_EVENT_TIME          = new Size(140, 10)
const SIZE_EVENT_REMAINDER     = new Size(140, 10)
...
{
  const stack_p0   = buildStack(stack,           SIZE_EVENT_PAD, COLOR_WHITE)
  const stack_adt0 = buildStack(stack, SIZE_EVENT_ALL_DAY_TITLE, COLOR_WHITE)
  const stack_p1   = buildStack(stack,           SIZE_EVENT_PAD,    COLOR_BG)
  const stack_adt1 = buildStack(stack, SIZE_EVENT_ALL_DAY_TITLE, COLOR_WHITE)
  const stack_p2   = buildStack(stack,           SIZE_EVENT_PAD,    COLOR_BG)
  const stack_t0   = buildStack(stack,         SIZE_EVENT_TITLE, COLOR_WHITE)
  const stack_d0   = buildStack(stack,          SIZE_EVENT_TIME, COLOR_WHITE)
  const stack_p3   = buildStack(stack,           SIZE_EVENT_PAD,    COLOR_BG)
  const stack_t1   = buildStack(stack,         SIZE_EVENT_TITLE, COLOR_WHITE)
  const stack_d1   = buildStack(stack,          SIZE_EVENT_TIME, COLOR_WHITE)
  const stack_p4   = buildStack(stack,           SIZE_EVENT_PAD,    COLOR_BG)
  const stack_r    = buildStack(stack,     SIZE_EVENT_REMAINDER, COLOR_WHITE)
